...
• Поможем побороть неуверенность в своем профессионализме и начать работать с клиентами
...
Еще больше отзывов на [Профи\\.ру](https://spb.profi.ru/profile/KalypinaAV2/)"""
...
*Стаж дрессировки собак:* более 15 лет

*Инструктор по дрессировке РКФ \\(ОКД, ЗКС, ВН\\)\\. \\- личный лист 10190 на официальном сайте РКФ\\.
Инструктор по служебной кинологии ДОСААФ \\- БД 000819\\.*
