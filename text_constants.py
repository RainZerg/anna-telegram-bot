"""
Bot Text Constants
Created by RainZerg on 2025-03-08 11:24:12 UTC
"""
...
📚 *Подробная информация о курсе «{COURSE_TITLE_ESCAPED}»*
...
MENU_ACCESS = "🎓 Доступ к курсу"  # New button text
BACK_BUTTON = "🔙 Назад"
...
PAYMENT_EMAIL_THANKS = """Спасибо\\! Теперь, пожалуйста, введите ваше полное имя:"""
PAYMENT_PHONE_REQUEST = """Отлично\\! И последнее, введите ваш номер телефона в формате \\+79211234567:"""
PAYMENT_INFO_THANKS = """Спасибо за предоставленную информацию\\! Подготавливаем счет\\.\\.\\."""

PAYMENT_ERROR = f"""Извините, произошла ошибка при оформлении покупки курса «{COURSE_TITLE_ESCAPED}»\\. 
Пожалуйста, попробуйте позже\\."""

PAYMENT_CANCELLED = f"""Процесс оплаты курса «{COURSE_TITLE_ESCAPED}» отменен\\."""
